...
const TopButton = styled.button<StyledTopButton>`
  padding: 10px;
  font-weight: 600;
  cursor: pointer;
...
const ProductColor = styled.div<StyledProductColor>`
  width: 20px;
  height: 20px;
  border-radius: 50%;
...
const SummaryItem = styled.div<StyledTopButton>`
  margin: 30px 0px;
  display: flex;
  justify-content: space-between;
  ...
  return (
    <Container>
      ...
      <Wrapper>
        ...
        <Top>
          <TopButton buttonType="">CONTINUE SHOPPING</TopButton>
          <TopTexts>
        ...
        <Bottom>
          ...
          <Summary>
            ...
            <SummaryItem buttonType="">
              <SummaryItemText>Subtotal</SummaryItemText>
              <SummaryItemPrice>₹ 3100</SummaryItemPrice>
            </SummaryItem>
            <SummaryItem buttonType="">
